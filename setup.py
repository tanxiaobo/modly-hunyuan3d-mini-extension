...
Example (manual test):
    python setup.py '{"python_exe":"C:/…/python.exe","ext_dir":"C:/…/hunyuan3d-2-mini","torch_flavor":"cuda","gpu_sm":
86,"cuda_version":128}'
"""
import json
import platform
...
def setup(python_exe: str, ext_dir: Path, gpu_sm: int, cuda_version: int = 0, torch_flavor: str = "cuda") -> None:
    venv = ext_dir / "venv"
